...
> Document status (2026-09-06): **Path-specific reference; needs re-audit**. It contains the earlier Chain/Hop descriptions and the decisions made at the time. Confirm the current guarantees of the event path against the code and the new verification protocol.
