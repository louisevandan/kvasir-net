...
**2026-09-16 H0 실제 봉인:** [benchmark-spec](../test/benchmarks/cluster-inference/release-a/benchmark-spec-qwen122b-h0-v1.json)과
[검증 보고](../tests/reports/release-a/20260916_072100.md)가 현재 source/binary/model/3-host/layout,
resource bounds, H1–H7 workload, A/B, telemetry와 LOAD/UNLOAD 수명을 결속했다. H0의 판정은
