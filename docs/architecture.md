...
Current per-layer permissions and dependencies, and change isolation for llama.cpp and concrete backends, are
owned by the [layer isolation contract](layer-isolation-contract.md). Keep that separate from the path description below.
