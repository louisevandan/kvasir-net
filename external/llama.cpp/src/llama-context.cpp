            ...
            for (const ggml_tensor * tensor : expected) {
                ...
                for (size_t i = 0; i < linkcpp_input_payloads.size(); ++i) {
                    ...
                    if (!used[i]
                        ...
                        && memcmp(desc.ne, tensor->ne, sizeof(desc.ne)) == 0
                        && memcmp(desc.nb, tensor->nb, sizeof(desc.nb)) == 0
