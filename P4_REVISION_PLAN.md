...
| 전제 | 12개 (§1.1) |
| 주제 | A~L 12개 |
| 확인된 결함 | `D-1`~`D-74` (철회·해소 4건 포함) |
| 보완 설계 | `P-1`~`P-56` (철회 2건 포함) |
| 미결 | `Q-1`~`Q-59` 중 **44건 미결**, 15건 결정·철회·해소 |
...
| Q-59 | `apps/llama`의 나머지(웹 UI·supervisor)는 어디로 가는가 | P-53. 백엔드만 옮기면 앱에 무엇이 남는지 정리 필요 |
