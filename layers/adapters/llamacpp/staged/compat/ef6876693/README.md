...
This version is an explicitly isolated candidate from official PR #27742 while
Qwen3.8-Flash-Next support is still under review. Its immutable PR-head SHA and
open-candidate status are recorded in the manifest; it must not replace a
stable master-based runtime pack without its own acceptance evidence.
