  ...
  -d '{ "model": "Qwen3.5-122B-A10B",
      ...
      },
      {
        ...
        items: [
          ...
          "网关角色由**网络指派，而非自行声明**：节点无法自行设置网关或 bridge 标志，而且只有在网关能看到它应答期间，在线时长才会被记账。",
...
infra      : bridge uptime/hr > gateway uptime/hr  (summed on top)`,
  ...
  staking: {
    title: "质押",
    summary: "把 KVR 锁进金库。它不再是运营者角色的门槛，也没有任何事情需要它。",
    blocks: [
      {
        t: "p",
        md: "质押是在钱包的质押面板中把 KVR 锁进金库。它曾是运营者角色的门槛——运营 bridge 或网关需要质押 100,000 KVR——而**这个要求已经取消**。运行任何节点都不需要质押，一个一枚 KVR 都没有的钱包也能注册节点并赚取。这两个基础设施角色改由网络指派，这比价格是更强的约束：旧的检查只在注册时读一次钱包余额，既不锁定也不再复查，因此同一笔 100,000 KVR 可以注册任意数量的节点，事后再把钱转走。",
      },
      {
        t: "ul",
        items: [
          "质押在钱包仪表盘的质押面板完成：输入数量、点击**质押**，该仓位便存放在金库中，直到你赎回。",
          "它不是任何事情的前提。节点奖励来自节点实际完成的工作，以及基础设施角色经过验证的在线时长——而不是来自持有余额。",
          "devnet 的质押利率目前为 **0%**，因此仓位本身不会产生任何收益。请把这个面板当作一个存在的机制，而不是赚取的途径。",
