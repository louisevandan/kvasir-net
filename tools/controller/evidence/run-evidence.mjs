...
export async function writeSummary(summaryFile, reportFile, runStats, traces) {
  ...
  summary.throughput = summarizeThroughput(runStats, summary.request_response);
  console.log(`P4_THROUGHPUT aggregate_tps=${summary.throughput.aggregate_tps} native_peak=${summary.throughput.admission.native_peak} slot_width=${summary.throughput.admission.agent_slot_width} verdict=${summary.throughput.verdict}`);
