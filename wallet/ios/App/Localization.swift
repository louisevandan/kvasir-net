...
private let ko: [String: String] = [
    ...
    "models.storedDesc": "브릿지가 이 기기에 내려받은 모델입니다. AI 추론에서 온디바이스로 사용할 수 있습니다.",
    "models.delete": "삭제",
    "models.deleteConfirm": "이 모델을 삭제할까요?",
    "models.emptyTitle": "다운로드한 모델 없음",
    "models.emptyHint": "노드로 참여해 분산 추론을 실행하면 브릿지가 이 기기로 모델을 내려받습니다.",
    ...
    "guide.nodeStep2": "Kvasir 브릿지가 노드의 추론 기여도를 보고하면 보상이 적립됩니다.",
    ...
    "monitor.nodes": "노드",
    "monitor.online": "온라인",
    "monitor.bridgeTitle": "브릿지 연결",
    "monitor.bridgeServing": "서빙 중",
    "monitor.bridgeConnectedIdle": "연결됨 · 대기",
    "monitor.bridgeDisconnected": "연결 끊김",
    "monitor.bridgeNone": "연결된 브릿지 없음 — 노드 설정에서 연결하세요",
    ...
    "nodeSettings.modeRpcDesc": "브릿지가 텐서 연산을 원격 실행 — 단순하나 네트워크 지연으로 느림",
    ...
    "nodeSettings.bridgeConnectTitle": "브릿지 연결",
    "nodeSettings.bridgeConnectDesc": "원격 브릿지에 지갑 서명으로 노드 토큰을 발급받아 폴링 등록 (OTP 불필요)",
    "nodeSettings.bridgeUrl": "브릿지 URL",
    "nodeSettings.bridgeConnectBtn": "지갑으로 연결",
    "nodeSettings.bridgeConnecting": "연결 중…",
    "nodeSettings.bridgeSigning": "지갑 서명 중…",
    "nodeSettings.bridgeConnected": "연결됨 · 노드 토큰 등록",
    "nodeSettings.bridgeConnectFailed": "실패",
    "nodeSettings.bridgeUrlMissing": "브릿지 URL을 입력하세요",
    "apiKey.title": "API 키",
    "apiKey.desc": "추론 크레딧에 쓰이는 키입니다. 이 기기에 저장되며, 게이트웨이가 더 이상 인정하지 않으면 재발급하세요. 크레딧 잔액은 지갑에 남아 영향받지 않습니다.",
    "apiKey.reissue": "키 재발급",
    "apiKey.working": "재발급 중…",
    "apiKey.ok": "새 키를 발급했습니다.",
    "apiKey.failed": "재발급 실패",
...
private let en: [String: String] = [
    ...
    "models.storedDesc": "Models the bridge has downloaded to this device. Usable on-device in AI inference.",
    "models.delete": "Delete",
    "models.deleteConfirm": "Delete this model?",
    "models.emptyTitle": "No downloaded models",
    "models.emptyHint": "When you join as a node and run distributed inference, the bridge downloads models to this device.",
    ...
    "guide.nodeStep2": "When the Kvasir bridge reports your node's inference contribution, rewards accrue.",
    ...
    "monitor.bridgeTitle": "Bridge connection",
    "monitor.bridgeServing": "Serving",
    "monitor.bridgeConnectedIdle": "Connected · idle",
    "monitor.bridgeDisconnected": "Disconnected",
    "monitor.bridgeNone": "No bridge connected — connect one in Node settings",
    ...
    "nodeSettings.modeRpcDesc": "The bridge runs tensor ops remotely — simple but slower due to network latency",
    ...
    "nodeSettings.bridgeConnectTitle": "Connect to a bridge",
    "nodeSettings.bridgeConnectDesc": "Sign in to a remote bridge with your wallet to mint a node token and register for polling (no OTP).",
    "nodeSettings.bridgeUrl": "Bridge URL",
    "nodeSettings.bridgeConnectBtn": "Connect with wallet",
    "nodeSettings.bridgeConnecting": "Connecting…",
    "nodeSettings.bridgeSigning": "Signing with wallet…",
    "nodeSettings.bridgeConnected": "Connected · node token registered",
    "nodeSettings.bridgeConnectFailed": "Failed",
    "nodeSettings.bridgeUrlMissing": "Enter a bridge URL",
    "apiKey.title": "API key",
    "apiKey.desc": "The key your inference credit is spent against. It is stored on this device — reissue it if the gateway stops accepting it. Your credit balance lives with the wallet and is not affected.",
    "apiKey.reissue": "Reissue key",
    "apiKey.working": "Reissuing…",
    "apiKey.ok": "A new key was issued.",
    "apiKey.failed": "Reissue failed",
...
private let zh: [String: String] = [
    ...
    "guide.nodeStep2": "当 Kvasir 桥接上报节点的推理贡献后，奖励便会累积。",
    ...
    "monitor.nodes": "节点",
    "monitor.online": "在线",
    "monitor.bridgeTitle": "桥接连接",
    "monitor.bridgeServing": "服务中",
    "monitor.bridgeConnectedIdle": "已连接 · 空闲",
    "monitor.bridgeDisconnected": "已断开",
    "monitor.bridgeNone": "未连接桥接 — 请在节点设置中连接",
    ...
    "nodeSettings.modeRpcDesc": "由桥接远程执行张量运算 — 简单但受网络延迟影响较慢",
...
private let es: [String: String] = [
    ...
    "guide.nodeStep2": "Cuando el bridge de Kvasir reporte la contribución de inferencia de tu nodo, se acumularán recompensas.",
    ...
    "monitor.bridgeTitle": "Conexión al bridge",
    "monitor.bridgeServing": "Sirviendo",
    "monitor.bridgeConnectedIdle": "Conectado · inactivo",
    "monitor.bridgeDisconnected": "Desconectado",
    "monitor.bridgeNone": "Ningún bridge conectado — conéctalo en Ajustes del nodo",
    ...
    "nodeSettings.modeRpcDesc": "El bridge ejecuta las operaciones de tensores de forma remota — sencillo pero más lento por la latencia de red",
...
private let ja: [String: String] = [
    ...
    "guide.nodeStep2": "Kvasir ブリッジがノードの推論貢献を報告すると、報酬が積み立てられます。",
    ...
    "monitor.bridgeTitle": "ブリッジ接続",
    "monitor.bridgeServing": "処理中",
    "monitor.bridgeConnectedIdle": "接続済み · 待機",
    "monitor.bridgeDisconnected": "切断",
    "monitor.bridgeNone": "接続中のブリッジなし — ノード設定で接続してください",
    ...
    "nodeSettings.modeRpcDesc": "ブリッジがテンソル演算をリモート実行 — シンプルだがネットワーク遅延で遅い",
...
private let fr: [String: String] = [
    ...
    "guide.nodeStep2": "Lorsque le bridge Kvasir signale la contribution d'inférence de votre nœud, des récompenses s'accumulent.",
    ...
    "monitor.bridgeTitle": "Connexion au bridge",
    "monitor.bridgeServing": "En service",
    "monitor.bridgeConnectedIdle": "Connecté · inactif",
    "monitor.bridgeDisconnected": "Déconnecté",
    "monitor.bridgeNone": "Aucun bridge connecté — connectez-en un dans les réglages du nœud",
    ...
    "nodeSettings.modeRpcDesc": "Le bridge exécute les opérations tensorielles à distance — simple mais plus lent en raison de la latence réseau",
...
private let de: [String: String] = [
    ...
    "guide.nodeStep2": "Wenn die Kvasir-Bridge den Inferenzbeitrag deines Nodes meldet, sammeln sich Belohnungen an.",
    ...
    "monitor.nodes": "Nodes",
    "monitor.online": "Online",
    "monitor.bridgeTitle": "Bridge-Verbindung",
    "monitor.bridgeServing": "Aktiv",
    "monitor.bridgeConnectedIdle": "Verbunden · inaktiv",
    "monitor.bridgeDisconnected": "Getrennt",
    "monitor.bridgeNone": "Keine Bridge verbunden — in den Node-Einstellungen verbinden",
    ...
    "nodeSettings.modeRpcDesc": "Die Bridge führt Tensor-Operationen remote aus — einfach, aber wegen Netzwerklatenz langsamer",
...
private let nl: [String: String] = [
    ...
    "guide.nodeStep2": "Wanneer de Kvasir-bridge de inferentiebijdrage van je node meldt, lopen beloningen op.",
    ...
    "monitor.nodes": "Nodes",
    "monitor.online": "Online",
    "monitor.bridgeTitle": "Bridge-verbinding",
    "monitor.bridgeServing": "Actief",
    "monitor.bridgeConnectedIdle": "Verbonden · inactief",
    "monitor.bridgeDisconnected": "Verbroken",
    "monitor.bridgeNone": "Geen bridge verbonden — verbind er een in Node-instellingen",
    ...
    "nodeSettings.modeRpcDesc": "De bridge voert tensorbewerkingen op afstand uit — eenvoudig maar trager door netwerklatentie",
...
private let idn: [String: String] = [
    ...
    "guide.nodeStep2": "Saat bridge Kvasir melaporkan kontribusi inferensi node Anda, imbalan bertambah.",
    ...
    "monitor.bridgeTitle": "Koneksi bridge",
    "monitor.bridgeServing": "Melayani",
    "monitor.bridgeConnectedIdle": "Terhubung · siaga",
    "monitor.bridgeDisconnected": "Terputus",
    "monitor.bridgeNone": "Tidak ada bridge terhubung — hubungkan di Pengaturan node",
    ...
    "nodeSettings.modeRpcDesc": "Bridge menjalankan operasi tensor dari jarak jauh — sederhana tetapi lebih lambat karena latensi jaringan",
