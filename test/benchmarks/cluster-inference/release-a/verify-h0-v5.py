#!/usr/bin/env python3
"""Run the complete local, non-model H0 v5 gate with fixed invocations."""
...
SPEC = DIRECTORY / "benchmark-spec-qwen122b-h0-v5.json"
...
def main() -> None:
    ...
    summary([sys.executable, str(DIRECTORY / "prepare-integrity-i0.py"), "--self-test"],
            {"passed": True, "tests": 7}, "I0 materializer")
    ...
    print(json.dumps({"passed": True, "checks": 16, "inspector_tests": 4,
                      "preflight_tests": 5, "h1_materializer_tests": 4,
                      "h1_judge_tests": 10, "integrity_spec_tests": 26,
