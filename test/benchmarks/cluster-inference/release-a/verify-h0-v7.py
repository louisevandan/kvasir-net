#!/usr/bin/env python3
"""Run the complete non-model H0 v7 gate with fixed invocations."""
...
SPEC = DIRECTORY / "benchmark-spec-qwen122b-h0-v7.json"
...
def main() -> None:
    ...
    summary([sys.executable, str(DIRECTORY / "prepare-h1-quality.py"), "--self-test"],
            {"passed": True, "tests": 6}, "H1 materializer")
    ...
    summary([sys.executable, str(DIRECTORY / "run-integrity-i0.py"), "--self-test"],
            {"passed": True, "tests": 6}, "I0 remote runner")
    ...
    if verified != expected:
        raise RuntimeError("H0 v7 verifier summary differs")
    print(json.dumps({"passed": True, "checks": 17, "inspector_tests": 4,
                      "preflight_tests": 5, "h1_materializer_tests": 6,
                      ...
                      "i0_runner_tests": 6, "i0_cleanup_tests": 7,
                      "i0_judge_tests": 15,
